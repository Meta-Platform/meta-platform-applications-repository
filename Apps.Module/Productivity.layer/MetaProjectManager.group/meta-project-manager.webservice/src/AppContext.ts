...
const GetContext = ({ projectStoreLib, dbFilePath, attachmentsDirPath, maxAttachmentBytes, ecosystemDataPath,
    ...
    const WatchExternalChanges = async () => {
        ...
        } catch(e: any){ /* tabela ainda não existe: o primeiro tick resolve */ }
        ...
        const tick = async () => {
            ...
            } catch(e: any){ /* best-effort: um tick que falha não derruba o serviço */ }
        }
