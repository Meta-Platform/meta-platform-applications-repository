...
const idOf = (arg: any, key: any) => (arg && typeof arg === "object") ? arg[key] : arg
...
const Actor = (p: any = {}) => {
    const base: any = { actorUserId: p.actorUserId, actorSessionId: p.actorSessionId, source: "api" }
