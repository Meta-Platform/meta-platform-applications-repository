...
const u16 = (n: any) => { const b = Buffer.alloc(2); b.writeUInt16LE(n >>> 0, 0); return b }
const u32 = (n: any) => { const b = Buffer.alloc(4); b.writeUInt32LE(n >>> 0, 0); return b }

const BuildZip = (entries: any) => {
    const files = []
    const central = []
    let offset = 0
