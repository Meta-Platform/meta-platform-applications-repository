...
const AuditStore = ({ models }: any) => {
    ...
    const WriteAudit = async ({ projectId, entityType, entityId, action, actor = {}, metadata, before, after }: any) => {
    ...
    const MakeListActivity = ({ assertGlobalActivityAccess }: any) => async ({
    ...
    const GetAuditEvent = async ({ event }: any = {}) => {
