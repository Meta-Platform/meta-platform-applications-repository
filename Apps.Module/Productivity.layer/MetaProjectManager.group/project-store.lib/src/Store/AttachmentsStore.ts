...
const AttachmentsStore = (ctx: any) => {
    ...
    const _persist = async ({ projectId, attachmentId, fileName, buffer }: any) => {
    ...
    const _store = async ({ item, name, buffer, mimeType, description, type, commentId, actor }: any) => {
    ...
    const AddFileAttachment = async ({ item, filePath, name, description, type, commentId, actor }: any = {}) => {
    ...
    const AddBufferAttachment = async ({ item, name, buffer, base64, mimeType, description, type, commentId, actor }: any = {}) => {
    ...
    const AddLinkAttachment = async ({ item, url, name, description, commentId, actor }: any = {}) => {
    ...
    const ListAttachments = async ({ item }: any = {}) => {
        const workItem = await store.ResolveItem(item)
    ...
    const ResolveAttachment = async (ref: any) => {
    ...
    const GetAttachment = async ({ attachment }: any = {}) => Serialize(await ResolveAttachment(attachment))

    // Retorna { buffer, name, mimeType } para download/export (não p/ anexos de link).
    const ReadAttachment = async ({ attachment }: any = {}) => {
    ...
    const RemoveAttachment = async ({ attachment, actor }: any = {}) => {
        const att = await ResolveAttachment(attachment)
