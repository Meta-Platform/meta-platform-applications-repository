...
const IsAgentGatedAction = ({ actionName, type, model }: any = {}) => {
    const policy: any = model === "delivery" ? AGENT_GATE_POLICY_DELIVERY : AGENT_GATE_POLICY
...
const AgentGatePolicyFor = (model: any) => model === "delivery" ? AGENT_GATE_POLICY_DELIVERY : AGENT_GATE_POLICY
...
const IsPlanningLockExempt = ({ actionName, type, fields }: any = {}) =>
