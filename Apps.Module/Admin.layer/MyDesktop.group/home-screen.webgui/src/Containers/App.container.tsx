...
// `ipcServices: "empty"` (o padrão): a área de trabalho fala por IPC em modo
// proxy, então no modo janela a lista existe só para passar o portão de render —
// o conteúdo não é consultado no caminho IPC.
