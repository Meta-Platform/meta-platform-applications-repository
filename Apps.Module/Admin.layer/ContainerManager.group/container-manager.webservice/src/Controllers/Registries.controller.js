...
const RegistriesController = ({
    ...
    const CreateRegistry = async ({ name, serverAddress, username, password, isDefault }) => {
        const store = await contexto.RequireStore()
    ...
    */
    const TestRegistry = async ({ connectionId, registryId, serverAddress, username, password }) => {
