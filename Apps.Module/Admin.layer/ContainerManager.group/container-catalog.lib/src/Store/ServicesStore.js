...
const ServicesStore = ({ models, secretBox, onEvent }) => {
    ...
    const ListServices = async ({ connectionId, stackId } = {}) => {
        const where = {}
    ...
    const GetServiceByContainer = async ({ connectionId, containerId }) =>
    ...
    */
    const MarkServiceFailed = async ({ serviceId, error }) =>
    ...
    const SetServiceCredentials = async ({ serviceId, fields }) => {
        await models.ServiceCredential.destroy({ where: { serviceId } })
    ...
    const GetCredentials = async ({ serviceId, reveal = false }) => {
    ...
    */
    const RevealCredentials = async ({ serviceId }) =>
