...
const DefineModels = require("./DefineModels") as (sequelize: any) => Record<string, any>
const CreateSecretBox = require("./Crypto/LocalSecretBox") as (options: { keyFilePath: string }) => any

// Cada store recebe o mesmo contexto e devolve um punhado de métodos, que a
// função abaixo espalha num objeto só.
type Store = (contexto: any) => Record<string, any>

const RecipesStore = require("./Store/RecipesStore") as Store
const ServicesStore = require("./Store/ServicesStore") as Store
const RegistriesStore = require("./Store/RegistriesStore") as Store
const ProvenanceStore = require("./Store/ProvenanceStore") as Store
const StacksStore = require("./Store/StacksStore") as Store
const AppStateStore = require("./Store/AppStateStore") as Store
const ActivityLogStore = require("./Store/ActivityLogStore") as Store

const ExpandirCaminho = (caminho: any) =>
...
*/
const COLUNAS_ACRESCENTADAS: Array<[tabela: string, coluna: string, tipo: string]> = []

const InitializeContainerCatalog = (options: any = {}) => {
