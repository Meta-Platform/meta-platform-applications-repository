...
// GetRequestByServer e embrulha o retorno em { data } — compatível com o shape
// que os componentes já leem. Usa Proxy: api.NomeDoMetodo(data) →
// invoke(apiName, "NomeDoMetodo", data).
